...
export default function Home() {
  return (
    ...
    <div className="relative bg-slate-800">
      ...
      <div id="blog" className="py-[10vh] flex flex-col items-center justify-center text-black">
      <Blog />
      </div>
      <div id="contact" className="py-[10vh] flex flex-col items-center justify-center text-black">
      <Contact />
      </div>
    </div>
